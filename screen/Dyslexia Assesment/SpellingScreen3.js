...
const DA_SpellingScreen3 = ({ navigation, route }) => {
  ...
  const onClickNext = () => {
    ...
    const timer = setTimeout(() => {
      // Navigate to GoodJobScreen
      navigation.navigate('DA_SpellingScreen4', { language });
    }, 100);
  };

  return (
    <View style={styles.container}>
      <Text style={styles.textTopic}>{language === 'ENGLISH' ? 'Spell the Word!' : 'சொல்லை தட்டச்சு செய்க!'}</Text>
...
export default DA_SpellingScreen3;
