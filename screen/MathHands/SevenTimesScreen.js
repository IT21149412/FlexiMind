...
const SevenTimesScreen = () => {
    ...
    if (cameraRef.current) {
      try {
        ...
        const response = await axios.post(
          `${BASE_URL}/process-seven-times-table`,
          formData,
          {
            headers: {
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.title}>7 Times Table</Text>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>
              7 x {fingerCount} = {result}
            </Text>
            <Text style={styles.modalText}>
              You raised {fingerCount} fingers! Great job!
            </Text>
            <LottieView
...
export default SevenTimesScreen;
